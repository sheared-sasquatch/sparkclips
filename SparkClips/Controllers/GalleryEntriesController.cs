...
namespace SparkClips.Controllers
{
    public class GalleryEntriesController : Controller
    {
        ...
        public GalleryEntriesController(SparkClipsContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("GalleryEntryID,Title,Body,Upvotes,Downvotes")] GalleryEntry galleryEntry)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GalleryEntryID,Title,Body,Upvotes,Downvotes")] GalleryEntry galleryEntry)
        {
